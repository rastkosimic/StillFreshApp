...
import { createOffer } from '@/services/vendorService';
import { colors } from '@/theme/colors';
import { OfferCategory } from '@/types';

type Props = VendorStackScreenProps<'CreateOffer'>;
...
export default function CreateOfferScreen({ navigation }: Props) {
  ...
  const onSubmit = async () => {
    ...
    try {
      ...
      Alert.alert(t('common.success'), t('vendor.offerCreated'), [
        {
          text: t('common.ok'),
    ...
    >
      ...
      >
        ...
        <FormCard>
          ...
          <StackedRow label={t('vendor.offer.fieldDescription')} required isLast>
            <TextInput
              value={description}
